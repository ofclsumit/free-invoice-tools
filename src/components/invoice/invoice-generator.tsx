...
export function InvoiceGenerator() {
  ...
  useEffect(() => {
    const session = consumePreviewSession<InvoiceFormData>("invoice")
  ...
  const handleShowPreview = useCallback(() => {
    ...
    savePreviewSession("invoice", currentValues, {
      logoOriginal,
      logoSettings,
      signatureOriginal,
      signatureSettings,
        ...
        <div className="max-w-4xl mx-auto w-full">
          <div className="space-y-6 min-w-0">
            ...
            <section className="form-section">
              ...
              />
              <p className="text-[11px] text-muted-foreground mt-1.5">Appears at the bottom of the invoice document.</p>
            </section>
