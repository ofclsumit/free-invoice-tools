...
export function QuotationGenerator() {
  ...
  useEffect(() => {
    const session = consumePreviewSession<QuotationFormData>("quotation")
  ...
  const handleShowPreview = useCallback(() => {
    ...
    savePreviewSession("quotation", currentValues, {
      logoOriginal,
      logoSettings,
      signatureOriginal,
      signatureSettings,
    ...
    <div className="flex flex-col min-h-[calc(100vh-8rem)]">
        ...
        <div className="max-w-4xl mx-auto w-full">
          <div className="space-y-6 min-w-0">
            ...
            <section className="form-section">
              <h2 className="font-display font-semibold text-sm mb-4 flex items-center gap-2">
                <span className="h-5 w-5 rounded-md bg-blue-600 flex items-center justify-center text-white text-xs font-bold">C</span>
                Client Details
              </h2>
              <div className="grid sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
            ...
            <section className="form-section">
              ...
              />
              <p className="text-[11px] text-muted-foreground mt-1.5">Appears at the bottom of the quotation document.</p>
            </section>
