...
export function RentReceiptView(props: RentReceiptViewProps) {
  ...
  return (
    <div className="document-page pdf-page" style={{ fontFamily: "'Inter', Arial, sans-serif", width: "210mm", minWidth: "210mm", maxWidth: "210mm", minHeight: "297mm", padding: "14mm 15mm", margin: "0 auto", boxSizing: "border-box", backgroundColor: "#ffffff" }}>
      <div style={{ background: "#fff", border: "2.5px solid #3aaa35", borderRadius: "4px", padding: "28px 32px 20px 32px", position: "relative", overflow: "hidden", minHeight: "260px" }}>
        ...
        <div style={{ position: "relative", zIndex: 1 }}>
          ...
          <div style={{ marginTop: "14px", fontSize: "11px", color: "#666", fontStyle: "italic" }}>
            Receipt Generated by Turnivo on <a href="https://turnivo.in" target="_blank" style={{ color: "#3aaa35", textDecoration: "none" }} rel="noreferrer">turnivo.in</a>
          </div>
        </div>
      </div>
    </div>
