...
import { ArrowLeft, ShoppingCart, Plus, Trash2, Download, Eye, Upload } from "lucide-react"
...
export default function PurchaseOrderPage() {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: `PurchaseOrder_${poNo}`,
  })
      ...
      <div className="min-h-screen bg-mesh py-8 px-4 sm:py-12">
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="flex flex-wrap justify-between items-center gap-4 print:hidden">
            ...
            <Button onClick={handlePrint} className="gap-2 bg-gradient-to-r from-teal-500 to-teal-600 text-white border-0 shadow-lg hover:shadow-xl transition-all">
            ...
            >
              <div className="flex justify-between items-start mb-12">
                ...
                <div className="text-right">
                  <h1 className="text-4xl font-light text-teal-600 uppercase tracking-widest mb-3">Purchase Order</h1>
                  <p className="text-gray-600 mb-1">PO #: <span className="font-medium text-gray-900">{poNo}</span></p>
                  <p className="text-gray-600">Date: <span className="font-medium text-gray-900">{poDate}</span></p>
                </div>
              </div>

              <div className="mb-12">
                <h3 className="text-gray-400 text-sm font-semibold uppercase tracking-wider mb-3">Supplier</h3>
                <p className="text-xl font-medium text-gray-900">{supplier || "Supplier Name"}</p>
              </div>
              ...
              <div className="flex justify-end">
                <div className="w-full sm:w-80 space-y-4 bg-gray-50 p-6 rounded-xl">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold text-teal-600">₹{fmt(total)}</span>
                  </div>
                </div>
              </div>
