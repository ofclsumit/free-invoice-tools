...
import { ArrowLeft, Hash, Search, Download } from "lucide-react"
    ...
    <div className="min-h-screen bg-mesh py-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-orange-500 to-orange-600 mb-4">
            <Hash className="h-7 w-7 text-white" />
          </div>
          <h1 className="text-3xl font-display font-bold">HSN Code Finder</h1>
          <p className="text-muted-foreground mt-2">Search HSN/SAC codes for products and services</p>
        </div>
        ...
        <p className="text-xs text-muted-foreground mt-4 text-center">This is a sample list. Consult official GST portal for complete HSN database.</p>
      </div>
    </div>
  )
}
