...
export async function generateMetadata(): Promise<Metadata> {
  const content = toolContentDictionary["salary-slip"]
  return {
    title: content.title,
...
export default function SalarySlipPage() {
  const content = toolContentDictionary["salary-slip"]
  return (
    <ToolLayout {...content} description={content.metaDescription} schemaUrl={`https://quoteflow.in/${content.slug}`} tool={<SalarySlipClient />} />
  )
}
