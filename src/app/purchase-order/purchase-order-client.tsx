...
export function PurchaseOrderClient() {
  ...
  useEffect(() => {
    const session = consumePreviewSession<POFormData>("purchase-order")
  ...
  const handleShowPreview = useCallback(() => {
    ...
    savePreviewSession("purchase-order", currentValues, {
      logoOriginal,
      logoSettings,
      signatureOriginal,
      signatureSettings,
    ...
    const currentPoNumber = currentValues.poNumber
        ...
        <div className="max-w-4xl mx-auto w-full">
          <div className="space-y-6 min-w-0">
            ...
            <section className="form-section">
              ...
              />
              <p className="text-[11px] text-muted-foreground mt-1.5">Appears at the bottom of the purchase order document.</p>
            </section>
