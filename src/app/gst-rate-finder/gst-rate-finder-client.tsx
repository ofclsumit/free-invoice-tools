              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer ${
                  selectedCategory === cat
                    ? "bg-violet-600 dark:bg-[#7c3aed] text-white shadow-xs font-bold"
                    : "bg-slate-100 hover:bg-slate-200 text-slate-700 dark:bg-white/[.06] dark:text-white/60 dark:hover:bg-white/[.1]"
                }`}
              >
                {cat}
              </button>
